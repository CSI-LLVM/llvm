...
; CHECK: declare void @__csi_before_load(i64, i8*, i32, i64)
; CHECK: declare void @__csi_after_load(i64, i8*, i32, i64)
; CHECK: declare void @__csi_before_store(i64, i8*, i32, i64)
; CHECK: declare void @__csi_after_store(i64, i8*, i32, i64)
; CHECK: declare void @__csi_bb_entry(i64)
; CHECK: declare void @__csi_bb_exit(i64)
; CHECK: declare void @__csi_before_call(i64, i64)
; CHECK: declare void @__csi_after_call(i64, i64)
